...
permalink: /publication/2026-04-01-Graphia
excerpt: 'This work introduces Graphia, the first general LLM-based framework for simulating dynamic social graphs, enabling graph-supervised post-training that aligns agent behaviors with both local interactions and emergent network structure.'
date: 2026-04-01
venue: 'ACL, oral presentation'
